...
dd = require "doubledecker/lib/mod"
nb = require("doubledecker/lib/nb/lib/nb")
...
-- VARIABLES
--
PATH = _path.data.."sketch/doubledecker/"
grid_dirty = true
screen_dirty = true
scale_names = {}
...
function init_doubledecker()
  --params:add_group("SKETCH - DOUBLEDECKER",46)
  nb:init()
  osc.send(
        { "localhost", 57120 },
        "/doubledecker/init",
